    ...
    public items: Item[] = [
        ...
        },
        {
            ...
            description: [
                ...
                `,
                `
                    از 28 اردیبهشت، مصاحبۀ هر دو دوره شروع می‌شوند که هر مصاحبه از دو قسمت گروهی و انفرادی تشکیل می‌شود
        ...
        },
        {
            ...
            description: [
                ...
                `
                    ...
                    و انتظار می‌رود کارآموزان همراه با آن پیش روند.
                `,
                `
                    در هر مرحله فهرستی از کارهایی که کارآموزان باید انجام دهند به آن‌ها داده می‌شود
                    و در پایان هر مرحله، با کارآموزانی که نتوانند حداقل امتیاز را کسب کنند خداحافظی می‌کنیم.
                `,
                `
